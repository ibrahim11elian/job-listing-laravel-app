                    ...
                    <div class="flex h-16 items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="hidden md:block">
                                <div class="ml-10 flex items-baseline gap-3">
                                    <x-nav-link
                                        href="/"
                                        :active="request()->is('/')"
                                    >
                            ...
                            <div class="ml-4 flex items-center gap-3 md:ml-6">
                                @auth
                                    <form action="/logout" method="POST">
                                        ...
                                        <button
                                            type="submit"
                                            class="text-white hover:bg-gray-500 px-3 text-sm py-2 rounded transition-colors duration-300 font-semibold"
                                        >
                                            Log Out
                                        </button>
                                    </form>
            ...
            @if (! empty($heading))
                <header class="bg-white shadow">
                    ...
                    >
                        ...
                        <a
                            href="/jobs/create"
                            class="{{ request()->is("jobs*") && ! request()->is("jobs/create") ? "block" : "hidden" }} px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 rounded-md hover:text-gray-500 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150"
                        >
                            Create Job
                        </a>
                    </div>
